    ...
    <div class="columns">
      <div class="column">
        <form action="{{route('permissions.store')}}" method="POST">
          ...
          <div class="columns" v-if="permissionType == 'crud'">
            ...
            <div class="column">
              <table class="table is-fullwidth">
                ...
                <tbody>
                  <tr v-if="resource.length >= 3 && crudSelected.length > 0" v-for="item in crudSelected">
          ...
          <button v-if="resource.length >= 3 && crudSelected.length > 0" class="button is-success">Create Permission</button>
        </form>
      </div>
    </div>
