      ...
      <div class="card">
        <div class="card-content">
          ...
          <form action="{{ route('password.email') }}" method="POST" role="form">
            ...
            <button class="button is-primary is-outlined is-fullwidth m-t-30">Get the reset Link</button>
            {{ csrf_field() }}
          </form>
        </div> <!-- end of card content -->
      </div>
      <h5 class="has-text-centered">
        <a href="{{ route('login') }}" class="is-muted m-t-30"><i class="fa fa-caret-left"></i> Back to Login</a>
      </h5>
    </div>
  </div>
</div>
