...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
      if ($request->permission_type == 'basic') {
        ...
        $request->session()->flash('success', 'Permission has been successfully added');
        ...
        //   Session::flash('success', 'Permissions were all successfully added');
          $request->session()->flash('success', 'Permissions were all successfully added');
          return redirect()->route('permissions.index');
        }
      } else {
    ...
    $request->session()->flash('success', 'Updated the '. $permission->display_name . ' permission.');
